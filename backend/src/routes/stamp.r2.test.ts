...
// Mock node-fetch for barcode image generation
jest.mock('node-fetch', () => {
  return jest.fn(async (url: string) => {
    // Mock barcode image - return a valid minimal PNG
    if (url.includes('bwipjs-api')) {
      ...
      const png = Buffer.from([
        ...
        0x08, 0xD7, 0x63, 0xF8, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x05, // compressed data
        0x1B, 0x69, 0x4D, 0x59, // CRC
